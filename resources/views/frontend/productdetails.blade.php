	...
	{{-- <header class="header-section header-normal">
		<div class="container-fluid">
			...
			<div class="header-right">
				<a href="cart.html" class="card-bag"><img src="img/icons/bag.png" alt=""><span>12</span></a>
...
<div class="page-area product-page spad">
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
				<figure>
					<img class="product-big-img" src="{{asset('images/employee')}}/{{$single_product_info->product_image}}" alt="">
				</figure>
		...
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="product-item">
					<figure>
						<img src="{{asset('images/employee')}}/{{$related_product->product_image}}" alt="">
